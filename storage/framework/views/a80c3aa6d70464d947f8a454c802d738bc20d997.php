                    ...
                    <div class="row no-margin fields">
                        ...
                        <div class="right">
                            <a href="<?php echo e(url('login')); ?>">
                                <h3>Ride with <?php echo e(Setting::get('site_title','Tranxit')); ?></h3>
    ...
    <div class="row white-section no-margin">
        <div class="container">
            ...
            <div class="col-md-4 content-block small">
                ...
                <div class="title-divider"></div>
                <p>When you arrive at your destination, either pay with cash or have your card automatically charged. With <?php echo e(Setting::get('site_title', 'Tranxit')); ?>, the choice is yours.</p>
            </div>
            ...
            <div class="car-tab">
                ...
                <div class="tab-content">
                  ...
                  <div id="premium" class="tab-pane fade">
                    <div class="car-slide">
                        <img src="<?php echo e(asset('/asset/img/car-slide2.png')); ?>">
                    </div>
                  </div>
                  <div id="accessibility" class="tab-pane fade">
                    <div class="car-slide">
                        <img src="<?php echo e(asset('/asset/img/car-slide3.png')); ?>">
                    </div>
                  </div>

                  <div id="carpool" class="tab-pane fade">
                    <div class="car-slide">
                        <img src="<?php echo e(asset('/asset/img/car-slide4.png')); ?>">
                    </div>
                  </div>
                ...
                <div class="input-group fare-form no-border-right">
                 ...
                 <div class="car-detail">
                    ...
                    <div class="car-radio">
                        ...
                        <label onclick="service_add('<?php echo e($service->id); ?>')" for="service_<?php echo e($service->id); ?>">
    ...
    if(error==0)
    {
            ...
            $.ajax({
               ...
               { 
                   ...
                   $("#div2").show();
                   $("#btnSubmit").hide();
                   var currency="<?php echo e(Setting::get('currency')); ?>";
